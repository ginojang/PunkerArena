...
Changes:
  ...
  Version 1.2.33:
   - Add Twist Propagation property to Boing Bones component (defaulted to true for new creations; defaulted to false for older creations for backward compatibility).
   - Version tracking.
