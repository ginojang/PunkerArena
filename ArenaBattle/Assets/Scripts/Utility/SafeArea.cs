...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        void ApplySafeArea (Rect r)
        {
			...
			// HACK (woodyzzm): Canvas.ForceUpdateCanvases() just in case, but not for now, only if some issues could happen.
			// See
			// 1. https://docs.unity3d.com/ScriptReference/Canvas.ForceUpdateCanvases.html
			// 2. https://answers.unity.com/questions/1007886/how-to-set-the-new-unity-ui-rect-transform-anchor.html
			// 3. https://docs.unity3d.com/Packages/com.unity.ugui@1.0/manual/class-RectTransform.html
		}
	}
}
