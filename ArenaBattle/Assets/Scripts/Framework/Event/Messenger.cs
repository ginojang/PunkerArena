...
#pragma warning restore 0414
    ...
    static public void AddListener<T, U, V, X, Z>(string eventType, Callback<T, U, V, X, Z> handler)
    {
        OnListenerAdding(eventType, handler);
        eventTable[eventType] = (Callback<T, U, V, X, Z>)eventTable[eventType] + handler;
    }
    ...
    static public void RemoveListener<T, U, V, X, Z>(string eventType, Callback<T, U, V, X, Z> handler)
    {
        OnListenerRemoving(eventType, handler);
        eventTable[eventType] = (Callback<T, U, V, X, Z>)eventTable[eventType] - handler;
        OnListenerRemoved(eventType);
    ...
    static public void Broadcast<T, U, V, X, Z>(string eventType, T arg1, U arg2, V arg3, X arg4, Z arg5)
    {
#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
		Debug.Log("MESSENGER\t" + System.DateTime.Now.ToString("hh:mm:ss.fff") + "\t\t\tInvoking \t\"" + eventType + "\"");
#endif
        ...
        if (eventTable.TryGetValue(eventType, out d))
        {
            Callback<T, U, V, X, Z> callback = d as Callback<T, U, V, X, Z>;
