...
namespace Malee.Editor {
	...
	{
		protected string GUIPrefabPath = "P:/HodooMobile/Assets/GUI/Prefabs";
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			GUILayout.Space(30);
			GUIPrefabPath = EditorGUILayout.TextField("Source(Addressable files) Folder", GUIPrefabPath);
			if (GUILayout.Button("...", GUILayout.Width(50)))
			{
				GUIPrefabPath = EditorUtility.OpenFolderPanel("Source (Addressable files) Folder", GUIPrefabPath, "");
				PlayerPrefs.SetString("GUIPrefabPath", GUIPrefabPath);
			}
			...
			*/
			...
			{
				//ReorderableList the = GetList(property, attribute as ReorderableAttribute);
			}
