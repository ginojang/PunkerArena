...
Shader "VESTINEL/CHA - Hair" {
	Properties 
	{
		...
		_Color1 ("ColorOverride1", Color) = (1,1,1,1)
		_Color2 ("ColorOverride2", Color) = (1,1,1,1)
		_Color3 ("ColorOverride3", Color) = (1,1,1,1)
