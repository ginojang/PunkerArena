...
Shader "VESTINEL/Particles/Mask Alpha Blended (2) ZOn" 
{
	Properties
	{
		...
		Pass
		{
			...
			v2f vert(VS_IN v)
			{
				...
				o.uv.xy = TRANSFORM_TEX (v.texcoord, _MainTex);  
					...
					o.maskUV_ff.xy = TRANSFORM_TEX (v.texcoord1, _MaskTex);  
				#else
					o.maskUV_ff.xy = TRANSFORM_TEX (v.texcoord, _MaskTex);  
				#endif
				...
				o.maskUV_ff.z = GetFogFactor(o.pos, unity_FogStart, unity_FogEnd);
				return o;
			}
