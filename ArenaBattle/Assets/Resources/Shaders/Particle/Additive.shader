...
Shader "VESTINEL/Particles/Additive" 
{
	Properties
	{
	...
	Subshader 
	{
		...
		Pass
        {
			...
			v2f vert(VS_IN v)
			{
				...
				#ifdef ROTATE_UV_ON
					o.uv.xy = rotateUVs(o.uv.xy, _RotateUVParameter.xy, _RotateUVParameter.z);
				#endif
				...
				#ifdef DISTORTION_ON
					o.uv.zw = TRANSFORM_TEX (v.texcoord, _DistortionTex) + _FlowSpeed.zw * _Time.y; 
				#endif
			...
			fixed4 frag (v2f i) : COLOR
			{
				...
				#ifdef DISTORTION_ON
					half2 distortionOffset = tex2D(_DistortionTex, i.uv.zw).xy * 2-1;
